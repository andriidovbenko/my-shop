    ...
    <Container maxW="3xl" py={12}>
      <VStack align="stretch" gap={6}>
        ...
        <VStack align="stretch" gap={4}>
          ...
          <Text color="text.default" lineHeight="tall">
            Доставка здійснюється службою «Нова Пошта» (на відділення, поштомат або кур&apos;єром) або «Укрпоштою» (на відділення або кур&apos;єром) — на вибір Покупця. Строки доставки залежать від роботи служби доставки та регіону.
          </Text>
          ...
          <Text color="text.default" lineHeight="tall">
            Продавець несе відповідальність за якість товару відповідно до чинного законодавства України. Продавець не несе відповідальності за затримки доставки з вини служб доставки («Нова Пошта», «Укрпошта»).
          </Text>
        </VStack>
      </VStack>
    </Container>
